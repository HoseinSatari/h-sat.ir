...
<div style="display: flex;flex-direction: column;z-index: 999">
    <a href="{{route('cat')}}"><button class="button-64" role="button" style="margin-bottom: 2rem"><span class="text">بلاگ</span></button></a>
    <a href="{{route('home')}}"><button class="button-64" role="button"><span class="text">رزومه</span></button></a>
</div>
</body>
</html>
